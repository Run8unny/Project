...
const ContactHeading = () => {
	return (
		<div
			className={`h-full overflow-hidden flex flex-row items-center justify-end box-border leading-[normal] tracking-[normal] text-left text-[8rem] text-darkblue  mq675:pl-[50px]`}
		>
			<h1 className='w-1/2 minh-[500px] flex-1 relative text-inherit uppercase font-extrabold font-[inherit] flex items-center max-w-full mq675:min-w-full mq450:text-[46px] mq900:text-[74px]'>
				<span>
					Let’s
