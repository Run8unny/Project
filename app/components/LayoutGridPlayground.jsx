	...
	return (
		<>
			<div className='w-full h-screen grid grid-rows-4 md:grid-rows-4 grid-cols-5 md:grid-cols-5 gap-6 text-[12px] relative overflow-hidden box-border leading-normal tracking-normal'>
				<div className='row-start-1 row-end-3 col-start-1 col-end-2 flex flex-col items-center justify-center p-1'>
					<ImagePlayground src='/assets/playground_page/pic20.png' />
				</div>
				<div className='row-start-1 row-end-2 col-start-2 col-end-3 flex flex-col items-start justify-start p-4'>
					<ImagePlayground src='/assets/playground_page/pic35.png' />
				</div>
				<div className='row-start-1 row-end-2 col-start-5 col-end-6 flex flex-col items-center justify-center p-6'>
				...
				<div className='row-start-2 row-end-3 col-start-5 col-end-6 flex flex-col items-center justify-center p-6'>
				...
				<div className='row-start-3 row-end-4 col-start-5 col-end-6 flex flex-col items-start justify-start p-6'>
					<ImagePlayground src='/assets/playground_page/pic28.png' />
				</div>
				<div className='row-start-4 row-end-5 col-start-1 col-end-2 flex flex-col items-start justify-start p-6'>
					<ImagePlayground src='/assets/playground_page/pic25.png' />
				</div>
				<div className='row-start-4 row-end-5 col-start-2 col-end-3 flex flex-col items-start justify-start p-6'>
					<ImagePlayground src='/assets/playground_page/pic23.png' />
				</div>
				<div className='row-start-4 row-end-5 col-start-3 col-end-4 flex flex-col items-start justify-start p-6'>
					<ImagePlayground src='/assets/playground_page/pic18.png' />
				</div>
				<div className='row-start-4 row-end-5 col-start-5 col-end-6 flex flex-col items-start justify-start p-6'>
			...
			<div className='w-full h-screen grid grid-rows-4 md:grid-rows-4 grid-cols-5 md:grid-cols-5 gap-6 text-[12px] relative overflow-hidden box-border leading-normal tracking-normal'>
				...
				<div className='row-start-1 row-end-3 col-start-5 col-end-6 flex flex-col items-center justify-center p-6'>
