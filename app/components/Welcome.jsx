...
const Welcome = () => {
	return (
		<div className='w-full relative bg-white overflow-hidden flex flex-col items-start justify-start pt-[2.812rem] pb-[0.062rem] pl-[1.75rem] pr-[1.375rem] box-border gap-[9.562rem] leading-[normal] tracking-[normal] text-left text-[1.563rem] text-black gap-[4.75rem] gap-[2.375rem]'>
			...
			<main className='self-stretch flex flex-row items-start justify-between max-w-full gap-[1.25rem] text-left text-[1.563rem] text-black mq1225:flex-wrap mq1225:justify-center'>
				<section className='w-[60.438rem] flex flex-col items-start justify-start gap-[0.937rem] max-w-full text-left text-[1.563rem] text-black '>
