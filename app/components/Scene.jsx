...
export default function Scene({ children }) {
	return (
		<div className='w-full rounded-3xl h-screen flex flex-col justify-center items-center p-4 py-28 md:py-16 bg-zinc-950 mq750:p-3 xs400:px-0 xs400:m-0 md:w-full'>
			<Canvas
				gl={{ antialias: true }}
				camera={{
					fov: 3.2,
