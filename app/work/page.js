...
export default function Page() {
	return (
		<div className='relative w-full overflow-hidden flex flex-col items-start justify-start pt-[6.25rem] px-[0rem] pb-[0rem] box-border gap-[11.75rem] leading-[normal] tracking-[normal] text-left text-[8.625rem] text-[transparent] font-be-vietnam-pro gap-[2.938rem] gap-[5.875rem]'>
