...
export default function RootLayout({ children }) {
	return (
		<html lang='en'>
			<ThemeProvider>
				<body
					className={`relative inset-0 w-full h-full ${questrial.className} bg-black light:bg-white bg-grid-white/[0.17] light:bg-grid-black/[0.17] flex items-center justify-center`}
				>
