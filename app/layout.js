...
export default function RootLayout({ children }) {
	return (
		<html lang='en'>
			<body
				className={`relative inset-0 w-full bg-zinc-950 light:bg-white bg-grid-white/[0.2] light:bg-grid-black/[0.17] flex items-center justify-center xs400:p-0 xs400:m-0 xs400:w-fit `}
			>
